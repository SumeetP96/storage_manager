...
class AllTransferExport implements FromQuery, WithMapping, WithHeadings, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    use Exportable;
    ...
    {
        return $this->allTransfers($this->request);
    }
