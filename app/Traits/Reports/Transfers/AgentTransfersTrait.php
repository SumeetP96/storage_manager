...
trait AgentTransfersTrait
{
     ...
     * @return Object
     */
    public function allAgentTransfers(Request $request, $agentId)
    {
        ...
        return $this->getFilteredAgentTransfersQuery($query, $request)
     ...
     * @return Object
     */
    public function getFilteredAgentTransfersQuery($query, Request $request)
    {
        // Date range filter
