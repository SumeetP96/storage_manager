          ...
          <div class="d-flex">
            <v-btn :color="$vuetify.theme.dark ? 'primary' : 'indigo'" text
              @click="editFromTable({ name: `${recordApiRoute}.action`,
                params: { id: dbRecord.id, backRoute: 'reports.agent_transfers', payload: { agentId: agentId } } })">
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.payload) this.agentId = this.$route.params.payload.agentId
