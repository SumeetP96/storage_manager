  ...
  <div>
    ...
    <v-col cols="12" class="px-8">
      ...
      <div v-else>
        ...
        <!-- Top -->
        <div class="overline grey--text" style="font-size: 0.9rem !important">Sale details</div>
        <div class="d-flex justify-space-between">
          ...
          <div class="rounded px-4 pb-3 pt-1 d-flex align-start justify-space-between" style="width: 28%"
            :class="$vuetify.theme.dark ? 'grey darken-3' : 'blue-grey lighten-4'">
              <!-- Sale No -->
              <div style="width: 30%">
                <div class="subtitle-1 font-weight-bold">Sale no
                  <span class="red--text text-h6"></span></div>
                <v-text-field
                  v-model="record.sale_no"
                  hide-details="auto"
                  outlined
                  disabled
                  placeholder="#"
            ...
            :class="$vuetify.theme.dark ? 'grey darken-3' : 'blue-grey lighten-4'">
              ...
              <div class="pr-2" style="width: 50%">
                ...
                <div class="d-flex">
                  ...
                  <v-btn v-if="record.from_godown_id" dark icon small tabindex="-1" class="indigo white--text ml-1" elevation="1"
              ...
              <div class="pl-2" style="width: 50%">
                <label class="subtitle-1 font-weight-bold">To customer
                  <span class="red--text text-h6">*</span></label>
                <div class="d-flex">
                  <div style="width: 100%">
                    <v-autocomplete
                  ...
                  <v-btn v-if="!record.to_godown_id" dark icon small tabindex="-1" class="indigo white--text ml-1" elevation="1"
                    @click="openDialog('godownDialog')">
                      <v-icon>mdi-plus</v-icon>
                  </v-btn>
                  <v-btn v-else dark icon small tabindex="-1" class="indigo white--text ml-1" elevation="1"
            ...
            <tr v-for="(product, index) in inputProducts" :key="index">
              ...
              <td>
                <div class="d-flex">
                  ...
                  <v-btn v-if="inputProducts[index].id" dark small icon tabindex="-1" class="indigo white--text ml-1" elevation="1"
        ...
        <v-row no-gutters class="rounded px-4 pb-3 pt-1"
          ...
          <v-col cols="3">
            ...
            <div class="d-flex">
              ...
              <v-btn v-if="!record.agent_id" dark small tabindex="-1" icon class="indigo white--text ml-1" elevation="1"
                @click="openDialog('agentDialog')">
                  <v-icon>mdi-plus</v-icon>
              </v-btn>
              <v-btn v-else dark small tabindex="-1" icon class="indigo white--text ml-1" elevation="1"
      ...
      <v-card :color="$vuetify.theme.dark ? 'grey darken-3' : 'blue-grey lighten-4'">
        ...
        <v-card-text class="pt-2 pb-8">
          <div v-if="!record.to_godown_id">
            ...
            <span style="display: none">{{ dialogRecord.is_account = true }}</span>
          </div>
