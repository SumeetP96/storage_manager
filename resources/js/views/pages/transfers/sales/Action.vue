    ...
    <v-col cols="12" md="11" class="mx-auto">
      ...
      <div v-else>
            ...
            <v-row>
              <v-col cols="12" md="8">
                ...
                <div v-if="productDetails.remarks"
                  :class="$vuetify.theme.dark ? '' : 'white'"
                  class="subtitle-2 px-3 py-1 rounded">
                    <span v-if="productDetails.remarks">{{ productDetails.remarks }}</span>
                </div>
              </v-col>
        ...
        <v-btn v-if="record.id" class="mt-8"
          ...
          @click="updateFromForm($route.params.id, { redirect: 'sales.index' })">
        ...
        <v-btn v-else
          ...
          @click="createFromForm({ redirect: 'sales.index' })">
