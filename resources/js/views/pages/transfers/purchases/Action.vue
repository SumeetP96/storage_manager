<template>
  <div>
    <AppBar backRoute="purchases.index" />
      ...
      <div v-else>
        ...
        <v-row>
            ...
            <v-row>
              <v-col cols="12" md="8">
                ...
                <div class="d-flex">
                  ...
                  <v-btn v-if="!record.product_id" dark icon class="indigo white--text ml-1" elevation="1"
                    @click="openDialog('productDialog')">
                      <v-icon>mdi-plus</v-icon>
                  </v-btn>
                  <v-btn v-else dark icon class="indigo white--text ml-1" elevation="1"
                    @click="openDialog('productDialog', 'products', record.product_id)">
                      <v-icon>mdi-circle-edit-outline</v-icon>
                  </v-btn>
                </div>
              </v-col>
              ...
              <v-col cols="12" md="3">
                ...
                <div v-if="record.product_id"
                  :class="$vuetify.theme.dark ? '' : 'white'"
                  class="subtitle-2 px-3 py-1 rounded text-right font-weight-bold">
                    <span class="pink--text pl-1">{{ productDetails.unit }}</span>
                </div>
              </v-col>
            </v-row>
          ...
          <v-col cols="12" md="4" class="pl-10">
            <div class="overline grey--text mb-2" style="font-size: 0.9rem !important">Additional details</div>
        ...
        <v-btn v-if="record.id" class="mt-8"
          ...
          @click="updateFromForm($route.params.id, { redirect: 'purchases.index' })">
        ...
        <v-btn v-else
          ...
          @click="createFromForm({ redirect: 'purchases.index' })">
    ...
    <v-dialog v-model="productDialog" max-width="800">
      <v-card>
        <v-card-title class="headline d-flex justify-space-between align-center">
          <div>
            <span v-if="record.product_id">Update Product</span>
