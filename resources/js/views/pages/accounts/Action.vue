<template>
  <div>
    <AppBar backRoute="accounts.index" />
    ...
    <v-col cols="12" md="10" lg="8" class="mx-auto">
      ...
      <div v-else>
        <div v-if="record.id" class="text-h5 py-5">Update Account</div>
        <div v-else class="text-h5 py-5">Create new Account</div>
        ...
        <v-btn v-if="record.id" class="mt-6"
          ...
          @click="updateFromForm($route.params.id,{ redirect: 'accounts.index' })">
        ...
        <v-btn v-else
          ...
          @click="createFromForm({ redirect: 'accounts.index' })">
